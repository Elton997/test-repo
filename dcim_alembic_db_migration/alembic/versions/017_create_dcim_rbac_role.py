"""
create dcim_rbac_role table

Revision ID: 017_create_dcim_rbac_role
Revises: 016_create_dcim_environment
Create Date: 2025-11-20 00:00:17.000000
"""
...
revision = "017_create_dcim_rbac_role"
down_revision = "016_create_dcim_environment"
branch_labels = None
depends_on = None

TABLE_NAME = "dcim_rbac_role"
SCHEMA = "dcim"
...
def _create_table() -> None:
    ...
    if not index_exists(SCHEMA, "ix_dcim_rbac_role_name"):
        op.create_index("ix_dcim_rbac_role_name", TABLE_NAME, ["name"], schema=SCHEMA)
...
def downgrade() -> None:
    ...
    op.drop_index("ix_dcim_rbac_role_name", table_name=TABLE_NAME, schema=SCHEMA)
